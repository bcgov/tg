          ...
          <section>
            ...
            <div className="tg-space-y-1">
              ...
              {(() => {
                if (node.type === 'application') {
                  return (
                    <>
                      ...
                      <p className="tg-text-gray-700 dark:tg-text-gray-300">
                        <strong>Identity Integrations: </strong>{' '}
                        {node.identityintegrations || 'N/A'}
                      </p>
                      <p className="tg-text-gray-700 dark:tg-text-gray-300">
                      ...
                      >
                        <a
                          href={`https://teca.powerappsportals.com/View-LOB-Information/?id=${node.paId}`}
                          target="_blank"
                ...
                } else if (node.type === 'server-appliance') {
                  return (
                    <>
                      <p className="tg-text-gray-700 dark:tg-text-gray-300">
                      ...
                      >
                        <a
                          href={`https://teca.powerappsportals.com/Server-Details/?id=${node.paId}`}
                          target="_blank"
                          className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                        >
                          View more details
                ...
                } else if (node.type === 'database-server') {
                  return (
                    <>
                      <p className="tg-text-gray-700 dark:tg-text-gray-300">
                        <strong>EOL Date:</strong>{' '}
                      ...
                      >
                        <a
                          href={`https://teca.powerappsportals.com/Database-Server-Details/?id=${node.paId}`}
                          target="_blank"
                          className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                        >
                          View more details
                  ...
                  return (
                    <p className="tg-text-gray-700 dark:tg-text-gray-300">
                      <strong>Details:</strong> Not available for this node type.
                    </p>
                  );
                }
              })()}
